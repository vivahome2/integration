...
EOT;
    ...
    $html .= '<tr><th><div class="subject">'.$name.'</div></th>';
    $html .= '<td><div>'.$trust_form->get_input_data($key).'</div>';
    $html .= '<p style="display:none" id="' . $key . '">' . $trust_form->get_input_raw_data($key) . '</p>';
		$html .= '</td></tr>';
	}
	$html .= <<<EOT
</tbody>
